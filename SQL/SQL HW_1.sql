...
8. Вывести пользователей где password 12333 select username  from qa_users where password like ('12333')
9. Вывести пользователей которые были созданы 2021-03-26 00:00:00 select username from qa_users  where created_on like '2021-03-26 00:00:00'
...
15. Вывести пользователей которые были созданы 2021-07-12 00:00:00 и у которых в имени есть слово Andrey select username from qa_users  where created_on = '2021-07-12 00:00:00' and username = 'Andrey'
...
22. Вывести пользователя у которых id меньше либо равно 37 select username from qa_users  where user_id < 37 or user_id = 37
23. Вывести пользователя у которых id больше либо равно 37 select username from qa_users  where user_id > 37 or user_id = 37
...
26. Вывести пользователей где password равен 12333, 1m313, 123313 select username from qa_users  where password ='12333' and password ='1m313' and password ='123313'
27. Вывести пользователей где created_on равен 2020-10-03 00:00:00, 2021-05-19 00:00:00, 2021-03-26 00:00:00 select username from qa_users  where created_on ='2020-10-03 00:00:00' and created_on ='2021-05-19 00:00:00' and created_on ='2021-03-26 00:00:00'
...
31. Вывести id пользователя, имя, дату создания пользователя. Отсортировать по порядку возрастания даты добавления пользоватлеля. select user_id, username, created_on from qa_users order by created_on asc
